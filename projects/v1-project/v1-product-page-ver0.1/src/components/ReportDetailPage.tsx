...
import { SkipLink, Button, ScrollToTop } from '@kenresearch/design-system/atoms';
...
export function ReportDetailPage({ report }: ReportDetailPageProps) {
  ...
  return (
    <>
      ...
      {/* DS TopNavigation — canonical navbar w/ brand CTA (2026-05-14 legacy parity) */}
      <TopNavigation
        logo={<KenLogo />}
        ...
        ctaButton={
          <Button variant="brand" size="sm" onClick={() => { window.location.href = '/contact'; }}>
            Book discovery call
          </Button>
        }
      />
      ...
      {/* 38. ScrollToTop — FAB appears past 400px scroll · legacy parity 2026-05-14 */}
      <ScrollToTop />
    </>
  );
}

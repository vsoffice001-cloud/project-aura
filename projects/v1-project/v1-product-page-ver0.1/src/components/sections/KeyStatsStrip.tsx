              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {/* Value — tabular-nums alignment · text-2xl DM Sans 600 per legacy parity (2026-05-14) — was text-xl Noto Serif 300 (too weak) */}
                    <p
                      className="text-2xl font-body font-semibold tabular-nums leading-tight"

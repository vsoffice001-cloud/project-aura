...
`cleanup` (build complete · awaiting v2b polish + tech intake). See [STATUS.md](STATUS.md) · [HANDOVER.md](HANDOVER.md).
...
| `/reports/[slug]` | Report PDP | Dynamic report detail page (slug-driven) |

Available slugs (mock): `australia-cold-chain-market-2022-2027` · `gcc-pharmaceutical-market-2024-2030`.

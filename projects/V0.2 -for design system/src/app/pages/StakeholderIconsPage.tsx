import { STAKEHOLDER_ICONS } from '@/app/constants/stakeholder-icons';
import { ArrowLeft, Copy, Check } from 'lucide-react';
import { useState } from 'react';

/**
 * KP 2.0 Design System - Stakeholder Icons Showcase Page
 * 
 * Displays all 15 stakeholder/target audience themed icons from Phosphor Icons.
 * These icons are used throughout the application for stakeholder cards.
 */

export function StakeholderIconsPage() {
  const [copiedIndex, setCopiedIndex] = useState<number | null>(null);
  const [copiedCode, setCopiedCode] = useState<string | null>(null);

  const iconDetails = [
    { name: 'Users', description: 'Users group' },
    { name: 'UsersFour', description: 'Four users' },
    { name: 'UsersThree', description: 'Three users' },
    { name: 'UserCircle', description: 'User in circle' },
    { name: 'UserFocus', description: 'Focused user' },
    { name: 'IdentificationCard', description: 'User identification' },
    { name: 'Handshake', description: 'Partnership/engagement' },
    { name: 'HandsClapping', description: 'Appreciation/support' },
    { name: 'Briefcase', description: 'Business stakeholders' },
    { name: 'UserList', description: 'User directory' },
    { name: 'AddressBook', description: 'Contact/audience' },
    { name: 'Chats', description: 'Communication' },
    { name: 'ChatCentered', description: 'Engagement' },
    { name: 'UserSound', description: 'Audience voice' },
    { name: 'Megaphone', description: 'Outreach/targeting' },
  ];
...
<${iconName} size={20} weight="regular" className="text-[var(--purple-500)]" />`;
  ...
  const usageCode = `import { getStakeholderIconByIndex } from '@/app/constants/stakeholder-icons';

// Get an icon by index (deterministic)
const Icon = getStakeholderIconByIndex(0); // Returns Users
...
<div className="size-10 rounded-lg bg-[var(--purple-100)]">
  ...
  const randomUsageCode = `import { getRandomStakeholderIcon } from '@/app/constants/stakeholder-icons';

// Get a random icon (changes on each render)
const RandomIcon = getRandomStakeholderIcon();
...
<div className="size-10 rounded-lg bg-[var(--purple-100)]">
  ...
  const directImportCode = `import { STAKEHOLDER_ICONS } from '@/app/constants/stakeholder-icons';

// Access any icon directly by index
const UsersIcon = STAKEHOLDER_ICONS[0];  // Users
const UsersFourIcon = STAKEHOLDER_ICONS[1];  // UsersFour

<UsersIcon size={20} weight="regular" className="text-[var(--purple-500)]" />`;
      ...
      <header className="bg-[var(--purple-500)] text-white py-8">
        <div className="max-w-7xl mx-auto px-[84.375px] lg:px-[112.5px]">
          ...
          <h1 className="font-display text-4xl tracking-tight mb-4">
            Stakeholder Icons Collection
          </h1>
          <p className="text-white/90 text-lg max-w-3xl">
            15 generic stakeholder and target audience themed icons from Phosphor Icons.
            All icons use regular/outline weight and represent people, audiences, engagement, and communication.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-[84.375px] lg:px-[112.5px] py-16">
        ...
        <section className="mb-16">
          ...
          <p className="text-[var(--black-500)] text-base leading-relaxed mb-4">
            ...
            They convey concepts like people, users, stakeholders, engagement, and communication.
          </p>
          <div className="bg-[var(--black-50)] rounded-[var(--radius-md)] p-6 border border-[var(--black-200)]">
            ...
            <ul className="space-y-2 text-[var(--black-500)]">
              <li>• Randomly assigned to stakeholder/audience cards</li>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {STAKEHOLDER_ICONS.map((Icon, index) => (
              <div
                key={index}
        ...
        <section className="mt-16 space-y-8">
          ...
          {/* Example 1: Using getStakeholderIconByIndex */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-[var(--black-500)] text-sm">
                View the 15 market segmentation themed icons collection
              </p>
            </a>
            <a
              href="/design-system"

 ...
 * 
 * SOURCE: vsoffice001-cloud/Design-System-vs-26 (GitHub)
 * This is the canonical color reference for Design System VS 26.
 */

// ============================================
// CLIPBOARD UTILITY (inline to avoid external dep)
// ============================================
  ...
  return (
    <div className="space-y-10">
      ...
      <ColorFamilySection
        ...
        colors={[
          { shade: '50', token: '--red-50', hex: '#fef5f5', rgb: '254, 245, 245', usage: 'Subtle backgrounds, lightest tint' },
          { shade: '100', token: '--red-100', hex: '#fde8e9', rgb: '253, 232, 233', usage: 'Alert highlights, notice backgrounds' },
          { shade: '200', token: '--red-200', hex: '#fbd1d2', rgb: '251, 209, 210', usage: 'Soft hover states, disabled buttons' },
          { shade: '300', token: '--red-300', hex: '#f5a3a6', rgb: '245, 163, 166', usage: 'Borders, soft accents' },
          { shade: '400', token: '--red-400', hex: '#e56d72', rgb: '229, 109, 114', usage: 'Icons, secondary interactive' },
          { shade: '500', token: '--red-500', hex: '#d23940', rgb: '210, 57, 64', usage: 'Links, badges, active states' },
          { shade: '600', token: '--red-600', hex: '#b01f24', rgb: '176, 31, 36', usage: 'PRIMARY BRAND - CTAs, buttons *', star: true },
          { shade: '700', token: '--red-700', hex: '#8f191e', rgb: '143, 25, 30', usage: 'Hover - Button hover states' },
          { shade: '800', token: '--red-800', hex: '#6e1317', rgb: '110, 19, 23', usage: 'Active - Pressed states' },
          { shade: '900', token: '--red-900', hex: '#4d0d10', rgb: '77, 13, 16', usage: 'Text on light, deep emphasis' },
        ]}
      />
...
// Complete data structure for download functionality
const colorData = {
  red: {
    50: '#fef5f5', 100: '#fde8e9', 200: '#fbd1d2', 300: '#f5a3a6', 400: '#e56d72',
    500: '#d23940', 600: '#b01f24', 700: '#8f191e', 800: '#6e1317', 900: '#4d0d10',
  },
  coral: {
...
function generateCSSExport() {
  return `:root {
  /* ========================================
     Design System VS 26 - Complete Color Palette
     ======================================== */
  
  /* 1. Ken Bold Red - Brand Identity (5% max usage) */
  --red-50: #fef5f5;
  --red-100: #fde8e9;
  --red-200: #fbd1d2;
  --red-300: #f5a3a6;
  ...
  /* 2. Coral/Terracotta - Warmth & Energy */
  --coral-50: #fffbf9;
  --coral-100: #fff5f1;
  --coral-200: #ffebe4;
  --coral-300: #fdd7cb;
  ...
  /* 3. Warm Editorial - Sophistication & Premium */
  --warm-50: #fefdfd;
  --warm-100: #fcfbfa;
  --warm-200: #f9f7f6;
  --warm-300: #f5f2f1;   /* BASE */
  --warm-400: #f0ebe9;
  --warm-500: #eae5e3;
  --warm-600: #d9d1ce;
  --warm-700: #c8bcb8;
  ...
  /* 4. Purple - Premium, Innovation & Insights */
  --purple-50: #f7f6fe;
  --purple-100: #efedfd;
  --purple-200: #dfdcfb;
  --purple-300: #c4bef7;
  ...
  /* 5. Periwinkle - Trust, Reliability & Calm */
  ...
  /* 6. Perano (Light Blue) - Calm, Professional & Data */
  --perano-50: #fcfdfe;
  --perano-100: #f9fbfe;
  --perano-200: #f4f8fd;
  --perano-300: #eff5fc;

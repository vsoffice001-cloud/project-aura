 ...
 * JS owns theme selection logic (11 themes x 2 modes = 22 combos).
...
export interface BadgeProps {
  ...
  /** Font weight: 400 (body), 600 (default pill/rounded/section labels) */
  fontWeight?: 400 | 600;
  as?: 'span' | 'div' | 'p';
  className?: string;
  style?: CSSProperties;
...
export function Badge({
  ...
  const badgeStyles: CSSProperties = {
    ...
    fontWeight: fontWeight || (isMinimal ? 400 : 600),
...
export function InfoBadge({ 
  children,
  variant = 'rounded' as BadgeVariant,
  mode = 'light' as BadgeMode,
  className = '',
}: { 
  children: ReactNode;
  variant?: BadgeVariant;
...
export function ClickableBadge({ 
  children,
  onClick,
  theme = 'neutral' as BadgeTheme,
  variant = 'pill' as BadgeVariant,
  mode = 'light' as BadgeMode,
  className = '',
}: { 
  children: ReactNode;

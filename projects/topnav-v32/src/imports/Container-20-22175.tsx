import svgPaths from "./svg-0l222skc1x";
...
export default function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center relative size-full" data-name="Container">
      <Container1 />
      <Container7 />
    </div>
  );

import svgPaths from "./svg-xczz4ern3k";
...
function Norm2() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative rounded-[10px] shadow-[0px_1px_30px_0px_rgba(128,108,224,0.2)] shrink-0" data-name="Norm">
      <Icons3 />
      <Container22 />
    </div>
  );
...
function Variant2() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center p-[4px] relative rounded-[10px] shrink-0" data-name="Variant 1">
      <div aria-hidden="true" className="absolute border border-[rgba(20,16,22,0.1)] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[0px_1px_8px_0px_rgba(128,108,224,0.3)]" />
      <Plus3 />
      <div className="absolute inset-0 rounded-[10px]" data-name="Border">
        <div aria-hidden="true" className="absolute border border-[rgba(20,16,22,0.1)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      </div>
...
function Container73() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[343px] items-start relative shrink-0 w-full" data-name="Container">
      <IndusOptions14 />
      <IndusOptions15 />
      <IndusOptions16 />
      <IndusOptions17 />
...
function Frame() {
  return <div className="absolute bg-gradient-to-b from-[rgba(255,255,255,0)] h-[49px] left-[-14.92px] to-white top-[339px] via-[40%] via-white w-[390px]" />;
}

function SurvOptn() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] h-[388px] items-start min-h-px min-w-px relative" data-name="Surv-optn">
      <Title />
      <Container73 />
      <Frame />
    </div>
...
export default function IndusNorm() {
  return (
    <div className="bg-white content-stretch flex gap-[24px] items-start p-[24px] relative shadow-[0px_0px_40px_0px_rgba(0,0,0,0.06)] size-full" data-name="Indus-norm">
      <Container />
      <Container66 />
    </div>
  );

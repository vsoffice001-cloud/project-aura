import svgPaths from "./svg-73xmw8np2j";
import imgC7AY3Ji68Rc1FTtya0J3MunVs8Webp from "figma:asset/7faa23fa8d7c7a3fdbd88dfb8cae5f7bdde996ee.png";
import { imgBackground } from "./svg-hw2l2";
...
function IconBlk2() {
  return (
    <div className="h-[12px] relative w-[13px]" data-name="Icon blk">
      <Down1 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#656565] text-[12px] uppercase w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[14.4px] whitespace-pre-wrap">Product Resources</p>
      </div>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[156.63px]" data-name="Container">
      <Container55 />
    </div>
  );
}
...
function Component9() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Component 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_23_4247)" id="Component 1">
          <path d={svgPaths.p2a99100} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.18222" />
        </g>
        <defs>
          <clipPath id="clip0_23_4247">
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[16px]" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg fill">
      <Component9 />
    </div>
  );
}

function MkpAfpU4WD54VxTp3ReLfz1CVzMSvg() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill />
    </div>
  );
}
...
function Icons() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvg />
    </div>
  );
}
...
function Container59() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#141016] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[16.8px]">Case Studies</p>
      </div>
    </div>
  );
}
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill1() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[16px]" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg fill">
      <Component10 />
    </div>
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvg1() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill1 />
    </div>
  );
}
...
function Icons1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvg1 />
    </div>
  );
}
...
function Container62() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#141016] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[16.8px]">Articles</p>
      </div>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="content-stretch flex flex-col gap-[15.99px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      <Container57 />
      <Container60 />
    </div>
  );
...
function Container53() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-[178px]" data-name="Container">
      <Container54 />
      <Container56 />
    </div>
  );
...
function Container65() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#656565] text-[12px] uppercase w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[14.4px] whitespace-pre-wrap">Our Insights</p>
      </div>
    </div>
  );
}
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill2() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[16px]" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg fill">
      <Component11 />
    </div>
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvg2() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill2 />
    </div>
  );
}
...
function Icons2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvg2 />
    </div>
  );
}
...
function Container69() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#141016] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[16.8px]">Blogs</p>
      </div>
    </div>
  );
}
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[16px]" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg fill">
      <Component12 />
    </div>
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvg3() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill3 />
    </div>
  );
}
...
function Icons3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvg3 />
    </div>
  );
}
...
function Container72() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#141016] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[16.8px]">{`POV's`}</p>
      </div>
    </div>
  );
}
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill4() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative shrink-0 size-[16px]" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg fill">
      <Component13 />
    </div>
...
function MkpAfpU4WD54VxTp3ReLfz1CVzMSvg4() {
  return (
    <div className="absolute content-stretch flex flex-col inset-0 items-start overflow-clip" data-name="mkpAfpU4wD54vxTp3reLFZ1cVzM.svg">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvgFill4 />
    </div>
  );
}
...
function Icons4() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icons">
      <MkpAfpU4WD54VxTp3ReLfz1CVzMSvg4 />
    </div>
  );
}
...
function Container75() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#141016] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[16.8px]">White Papers</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-start justify-center left-0 top-[-0.75px]" data-name="Container">
      <Container53 />
      <Container63 />
    </div>
  );
...
function C7AY3Ji68Rc1FTtya0J3MunVs8Webp() {
  return (
    <div className="absolute inset-0 rounded-[10px]" data-name="C7aY3ji68Rc1fTTYA0j3munVS8.webp">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[10px]">
        <img alt="" className="absolute h-full left-[-51.96%] max-w-none top-0 w-[203.92%]" src={imgC7AY3Ji68Rc1FTtya0J3MunVs8Webp} />
      </div>
    </div>
  );
}
...
function Background1() {
  return <div className="absolute bg-[#141016] inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0%_0%] mask-size-[100%_100%]" data-name="Background" style={{ maskImage: `url('${imgBackground}')` }} />;
}

function Container102() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-black whitespace-nowrap">
        <p className="leading-[12px]">Case Studies</p>
      </div>
    </div>
  );
}
...
function Background2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center overflow-clip px-[4px] py-[2px] relative rounded-[5px] shrink-0" data-name="Background">
      <Container101 />
    </div>
  );
}
...
function Container104() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[28px] relative shrink-0 text-[20px] text-white w-full whitespace-pre-wrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="mb-0">How a Global Industrial</p>
        <p className="mb-0">Conglomerate Evaluated</p>
        <p>Growth Opportunities in</p>
      </div>
    </div>
  );
}
...
function Container100() {
  return (
    <div className="absolute bottom-[36px] content-stretch flex flex-col gap-[8px] h-[385px] items-start justify-end left-[399px] overflow-clip p-[24px] right-[33px] rounded-[10px]" data-name="Container">
      <C7AY3Ji68Rc1FTtya0J3MunVs8Webp />
      <div className="absolute h-[385px] left-0 rounded-[10px] top-0 w-[339.84px]" data-name="Border">
...
function Opt() {
  return (
    <div className="bg-[#fafafe] flex-[1_0_0] min-h-px min-w-px relative rounded-[20px] w-full" data-name="opt-4">
      <Container77 />
      <Container100 />
    </div>
  );
...
function Container76() {
  return (
    <div className="absolute content-stretch flex flex-col h-[461px] items-start justify-center left-[32.64%] right-[0.36%] top-0" data-name="Container">
      <Opt />
    </div>
  );
}
...
function Container51() {
  return (
    <div className="h-[461px] relative shrink-0 w-full" data-name="Container">
      <Container52 />
      <Container76 />
    </div>
  );
...
function Resources1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[24px] relative shadow-[0px_0px_40px_0px_rgba(0,0,0,0.06)] shrink-0 w-[1200px]" data-name="Resources">
      <Container51 />
    </div>
  );
}
...
export default function Resources() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Resources">
      <Wht />
      <Resources1 />
    </div>
  );

import svgPaths from "./svg-2r1gg7j92c";

function Component() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Component 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_13_12823)" id="Component 1">
          <g id="Vector" />
...
export default function MenuTiles() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center overflow-clip px-[12px] py-[8px] relative rounded-[10px] shadow-[0px_1px_30px_-5px_rgba(128,108,224,0.2)] size-full" data-name="Menu tiles 3">
      <Icons />
      <Container />
    </div>
  );

/**
 * IndustryNavItem Component
 * 
 * Specialized navigation item for Industry dropdown listings.
 * Optimized for long industry names with proper text truncation.
 * 
 * Features:
 ...
 * - PROPER text truncation for long names (single-line with ellipsis)
 * - Tooltip shows full name on hover (TOP positioned)
 * - Fixed width column (200px) for consistent truncation
 * 
 * Design Specs:
 * - Padding: 12px × 8px (horizontal × vertical)
 ...
 *   isSelected={activeIndustry === 'automotive'}
 *   onMouseEnter={() => setActiveIndustry('automotive')}
 * />
 * ```
 */
...
export function IndustryNavItem({
  icon,
  label,
  isSelected,
  onMouseEnter,

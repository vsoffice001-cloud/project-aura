...
| `design-system/core-v2` | Next 15 + RSC | `ready-for-tech` | 2026-05-15 | design (handing) → tech-team | **Ready for tech intake 2026-05-15.** 100% OG `Design_system_vs_26` coverage (DS Port Phase 1-3 complete). 23 hooks · ~20 atoms · ~30 molecules · ~50 organisms · 46 shadcn ui · 13 public types · 4 patterns · Highcharts theme + 5 presets. 153 `data-component` attrs added 2026-05-15 (QA discoverability). ~500 tokens in base.css unlayered `:root` · foundation lock complete 2026-05-15. `--color-neutral-500` bumped to #6b6b6b for AA. `MethodologySection` eyebrow prop-lifted. COMPOSITION_GRAMMAR.md added as third canonical doc. Typecheck + build clean. STATUS.md + HANDOVER.md present. Adapter pattern for data-coupled organisms. Open for tech: ESLint setup (lint script aspirational · not installed) · Storybook stories deferred · StatCard count-up default-on (motion call) · other organism eyebrow strings audit deferred. Pre-npm-publish: flip exports map to `dist/` paths per `_exports_note`. |
...
| `v1-project/v1-product-page-ver0.1` | Next.js 15 | `deleted-2026-05-25` | 2026-05-25 | — | DELETED 2026-05-25. Superseded by ver0.4 (2026-05-22 sprint). Recoverable from git history if needed. |
| `v1-project/v1-product-page-ver0.2` | Next.js 15 | `deleted-2026-05-25` | 2026-05-25 | — | DELETED 2026-05-25. Superseded by ver0.4. Recoverable from git history. |
| `v1-project/v1-product-page-ver0.3` | Next.js 15 | `deleted-2026-05-25` | 2026-05-25 | — | DELETED 2026-05-25. Superseded by ver0.4 (full 24-section build · charts library promoted to DS · ref-aligned). Recoverable from git history. Original handover-gate at `HANDOVER-GATE-2026-05-20.md` (deleted with parent). |
| `v1-project/v1-product-page-ver0.4` | Next.js 16 | `polish-active` | 2026-05-25 | design | **Active.** 24-section Australia Cold Chain PDP. All charts/tables imported from `@kenresearch/design-system/charts` post-2026-05-25 promote sprint. 6 P0 chart/table bugs fixed (bubble label · scenario white · submarkets dual · opportunities single · property density · header wash). UX audit Phase A done · Phase B/C pending. Dev: `pnpm dev --port 3040`. |
| `charts-showcase` | Next.js 15 | `exploring` | 2026-05-25 | design | Standalone showcase for `@kenresearch/design-system/charts` library · 7 charts + 2 tables + 3 primitives demoed. Dev: `pnpm dev --port 3070`. Workspace dep via root `pnpm-workspace.yaml`. NO production wiring · sandbox for DS chart consumers. |

/**
 * Popover Icons — SVG icon components for AuthPopover menu items.
 *
 * 24×24 viewBox, sized via parent `className`. `currentColor` for inheritance.
 *
 * @promotedFrom topnav-v32/src/app/components/navbar/organisms/popover-icons.tsx
 */
